...
/**
 * ***15.34 (Simulation: self-avoiding random walk) A self-avoiding walk in a lattice
 ...
 * ends at a point on the boundary, as shown in Figure 15.39a, or ends at a deadend point (i.e., surrounded by four points that have already been visited), as
 * shown in Figure 15.39b. Assume the size of the lattice is 16 by 16.
 *
 * @author Alex Golub
 * @since October 10, 2023 9:07 PM
 */
public class Ex1534 extends Application {

    private final double paneWidth = 300;
    private final double paneHeight = 250;
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("***Ex1534"); // Set the stage title
    ...
    class Lattice extends Pane {
        ...
        private final Point[][] lattice = new Point[N + 1][N + 1];
        private final double hGap = paneWidth / N;
        private final double vGap = paneHeight / N;
