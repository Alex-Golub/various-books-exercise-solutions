...
public class PaneCollection {
    ...
    public static MyPoint getCenterPoint(Line line) {
        return new MyPoint((line.getStartX() + line.getEndX()) / 2,
    ...
    public static boolean containsPoint(List<Point2D> points, double x, double y) {
    ...
    public static boolean removePoint(List<Point2D> points, double x, double y) {
        int index = 0;
        for (Point2D p : points) {
