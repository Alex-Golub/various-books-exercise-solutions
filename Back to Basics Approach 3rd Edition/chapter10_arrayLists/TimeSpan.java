...
class TimeSpan implements Comparable<TimeSpan> {
  ...
  /**
   * A time span that represents a shorter amount of time is considered
   * to be “less than” one that represents a longer amount of time.
   * For example, a span of 3 hours and 15 minutes is greater
   * than a span of 1 hour and 40 minutes.
   */
  @Override
  public int compareTo(TimeSpan o) {
    return (this.hours * 60 + this.minutes) - (o.hours * 60 - o.minutes);
  }
